...
off='\x1b[m'
clear
#Script Editedd By Setiawan
url1="scstn22.stn-cloud.my.id/shell"
url2="scstn22.stn-cloud.my.id/stunnel5"
url3="scstn22.stn-cloud.my.id/function"
url4="scstn22.stn-cloud.my.id/package"
url5="scstn22.stn-cloud.my.id/dll"
...
wget -O /etc/pam.d/common-password "https://${url1}/password"
...
curl https://${url1}/nginx.conf > /etc/nginx/nginx.conf
curl https://${url1}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${url1}/index.html1"
/etc/init.d/nginx restart
cd

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://${url1}/badvpn-udpgw64"
...
wget -O /etc/squid/squid.conf "https://${url1}/squid3.conf"
...
wget https://${url1}/vnstat-2.6.tar.gz
...
# install stunnel 5 
cd /root/
wget -q -O stunnel5.zip "https://${url2}/stunnel5.zip"
...
wget -q -O /etc/init.d/stunnel5 "https://${url2}/stunnel5.init"
...
cd /etc/openvpn/
wget https://scstn22.stn-cloud.my.id/package/vpn.zip
unzip vpn.zip
rm -f vpn.zip
...
# Install BBR
wget https://${url1}/bbr.sh && chmod +x bbr.sh && ./bbr.sh

# Ganti Banner
wget -O /etc/issue.net "https://${url1}/issue.net"
...
mkdir /root/menu
cd /root/menu
wget https://scstn22.stn-cloud.my.id/package/packet.zip
unzip packet.zip
rm -rf packet.zip
mv /root/menu/swapkvm.sh /usr/bin/swapkvm
mv /root/menu/banner.sh /usr/bin/banner
mv /root/menu/stat.sh /usr/bin/stat
